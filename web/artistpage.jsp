                        ...
                        <div class="col-md-12  m-0 p-0">
                            ...
                            <div style="  font-family: 'Playfair Display', serif;">
                                <div style="margin-top:8rem;">
                                    <img src="img/musics/<%=sname%>" style="max-width: 250px; max-height: 200px;">
                                </div>
                                <div style="margin-left: 18rem; margin-top: -12rem; font-size: 1.8rem;">
                                    <p >Artist  <span>&nbsp; <%=name%></span></p>
                                </div>
                            </div>
                            <div style="margin-top: 14rem;">
                                <ul class="list-group">
                                    <%         SessionFactory f = FactoryProvider.getFactory();
                                        ...
                                        Query q = ss.createQuery("from Songs where artist=:g ");
                                        q.setParameter("g", name);
                                    ...
                                    <li class="list-group-item" style="background-color:rgba(0,0,0,0.6); width: 50rem;font-size: 1.4rem;">
                                                                                   <a href="artplay.jsp?ph=<%=mu.getThumb()%>&song=<%=mu.getSong()%>&sname=<%=mu.getSongName()%>&art=<%=mu.getArtist()%>&cat=<%=mu.getCategory()%>  " style="position:relative;">
                                                                                       <img src="img/musics/<%=mu.getThumb()%>"  style="max-width: 50px; max-height: 50px;">&nbsp;<span style="color:white;margin-left: 1rem; font-family: 'Playfair Display', serif;" ><%=mu.getSongName()%></span></a>
