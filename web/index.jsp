    ...
    <body  style="background-color:rgba(0,0,0,0.9);overflow-x: hidden;">
                ...
                <div class="col-md-9   " style="margin-left: -3rem; position: relative;">
                    ...
                    <div class="row">
                        <div class="col-md-12  m-0 p-0">
                            <div style="background-image: url(img/h.jpg); height: 22rem; width:65rem; margin-left: -1rem;">
                                ...
                                <h1 style="color: white ; position: absolute;   margin-top: 8rem; margin-left: 3rem;">Let's Music</h1>
                                <h1 style="color: white ; position: absolute;   margin-top: 12rem; margin-left: 5rem;">Speak</h1>

                                <img src="img/mic.png" style="max-width:700px; max-height: 300px; float: right; margin-top: 4rem; margin-right: 9rem;">

                            </div>

                            <!--search-->
                            <div id="show" style="position:absolute; z-index: 1 ;margin-top:-18rem;margin-left: 2.6rem; width: 14.6rem; position: fixed; background-color: rgba(0,0,0,0.9);">
                            ...
                            <div style="margin-top:2rem;">
                                <p style="font-size:1.9rem; font-family: 'Redressed', cursive;">Popular Artist</p>
                                ...
                                <div class="card-deck">
                                    <%
                                        ...
                                        Query qy = slm.createQuery("from artist order by RAND()");
                            ...
                            <div style="margin-top:2rem;">
                                <p style="font-size:1.9rem; font-family: 'Redressed', cursive;">Party songs</p>

                                <div class="card-columns">
                                    <%         SessionFactory f = FactoryProvider.getFactory();
                                        Session ss = f.openSession();

                                        Query q = ss.createQuery("from Songs where category='party song' order by RAND() ");
                                        q.setMaxResults(6);
                            ...
                            <div style="margin-top:3rem;">
                                <p style="font-size:1.9rem; font-family: 'Redressed', cursive;">Love songs</p>

                                <div class="card-columns">
                                    <%         SessionFactory fac = FactoryProvider.getFactory();
                                        Session ses = fac.openSession();

                                        Query qur = ses.createQuery("from Songs where category='love song' order by RAND()");
                                        qur.setMaxResults(6);
                                        List<Songs> lis = qur.list();
                            ...
                            <!--party song-->
                            <div style="margin-top:3rem;">
                                <p style="font-size:1.9rem; font-family: 'Redressed', cursive;">Sad songs</p>

                                <div class="card-columns">
                                    <%         SessionFactory factory = FactoryProvider.getFactory();
                                        Session sesi = factory.openSession();

                                        Query qury = sesi.createQuery("from Songs where category='sad song' order by RAND() ");
                                        qury.setMaxResults(6);
                                        List<Songs> li = qury.list();
                            ...
                            <!--party song-->
                            <div style="margin-top:3rem;">
                                <p style="font-size:1.9rem; font-family: 'Redressed', cursive;">Punjabi songs</p>

                                <div class="card-columns">
                                    <%         SessionFactory factoryy = FactoryProvider.getFactory();
                                        Session sesio = factoryy.openSession();

                                        Query quryy = sesio.createQuery("from Songs where category='punjabi song' order by RAND() ");
                                        quryy.setMaxResults(6);
        ...
        $('.xyz span').on('click', function () {
            ...
            if (playing)
            {
                ...
                $('#ply').addClass("fa-play-circle");
            } else {
                $(this).removeClass("fa-play-circle");
                $(this).addClass("fa-pause");
                pla();
                $('#cpl').show();
                   $('#ply').removeClass("fa-play-circle");
