  ...
  border-radius: 10px;
    ...
    <body style="background-color:rgba(0,0,0,0.8);">
        ...
        <%
            ...
            Query qy = ss.createQuery("from listsong where userid=:g and playlistname=:jh ");
            qy.setParameter("g",us.getUserid());
            qy.setParameter("jh",n);

            List<listsong> list = qy.list();
            ...
            <div class="row mt-5">
                <div class="col-md-11 " style="background-color:rgba(0,0,0,0.3); height: 28rem; margin-left: 3rem;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <p style="margin-left:3rem; margin-top:3rem; color:white; font-size:1.8rem;">  Playlist : &nbsp;&nbsp; <span  id="nam" style="font-size:1.6rem;" ><%=n%> </span></p>
                            <p style="margin-left:3rem; margin-top:1rem; color:white; font-size:1.8rem;">  created : &nbsp;&nbsp; <span  id="art" style="font-size:1.2rem;"><%=us.getUserid()%>  </span></p>
